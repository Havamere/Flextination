...
function addResults(place) {
    ...
    service.getDetails(place, function(result, status) {
        ...
        $('#mapResults').append("<p><b>name:</b> " + result.name + "<p><b>address: </b>" + result.formatted_address + "<p><b>phone number:  </b>" + result.formatted_phone_number + "<p><b>rating: </b>" + result.rating + "<p>___________________________");
