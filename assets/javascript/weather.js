...
(function() {
  ...
  var start = moment(destinationStartDate);
  var end = moment(destinationEndDate);

  $("#search-parameters").append(destinationCity + " between the dates of " + start.format('MM/DD/YYYY') + " and " + end.calendar('MM/DD/YYYY') + ".");
